//Variavel 
var x = 200,
    y = 841, //parametros da Taryn
    b = 0,
    o = 60, //parametros do boneco 
    canvas = document.querySelector('canvas'), //declara que o elemento "canvas" deve ser selecionado
    c = canvas.getContext('2d'),
    ctx = canvas.getContext('2d') //Desenha o canvas na tela
...
function Taryn() {
    ...
    if (x > 1491) {
        x = 1300
        b = b + 1
    } //Se o elemento for maior que 1491 é adicionado 1 a variavel b
    if (b == 3) {
